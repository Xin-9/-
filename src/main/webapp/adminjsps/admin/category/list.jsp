...
<c:forEach items="${categorypovos }" var="categorypovo">    	
    	<tr class="trOneLevel">
    		...
    		<td width="200px;">
    		  <a href="<c:url value='/category1/getCname.action'/>">添加二级分类</a>
    		  <a href="<c:url value='/category1/getCategoryByCid/${dad.cid}.action'/>">修改</a>
    		  <a onclick="return confirm('您是否真要删除该一级分类？')" 
			  href="/category1/removeCategoryByCid/${dad.cid}.action;"/>删除</a>
    		</td>
    	</tr>
   <c:forEach items="${categorypovo.children }" var="child">
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  <a href="<c:url value='/category1/getCategoryByCid2/${child.cid}.action'/>">修改</a>
    		  <a onclick="return confirm('您是否真要删除该二级分类？')" href="/category1/removeCategoryByCid/${child.cid}.action"/>删除</a>
    		</td>
    	</tr>
   </c:forEach>
</c:forEach>
