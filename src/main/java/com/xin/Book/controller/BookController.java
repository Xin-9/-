package com.xin.Book.controller;
...
public class BookController {
	...
	public  String   getBooksBySearch(String   keywords,Model  model,@RequestParam(defaultValue="1")Integer pageNum) throws Exception {
